...
const { ObsidianLoader } = require('langchain/document_loaders');
const { VectorstoreIndexCreator } = require('langchain/indexes');
const { ChromaVectorStore } = require('langchain/vectorstores');
...
// export async function createObsidianIndex() {
//     try {
//         const loader = new ObsidianLoader(
//           '/Users/dantekim/Documents/Areas/PKM/JARVIS/🌎 Atlas/Sources 📥/Books'
//         );
